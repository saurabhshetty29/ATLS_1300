"""
This is start code for ATLS 1300/5650. By choosing this start code, you are 
choosing to use a selfie as your background for drawing. The selfie code will
run automatically.
...
is no countdown. To retake an image, simply run your code again. To keep an image, 
comment out the labeled parts.
